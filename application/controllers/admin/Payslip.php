...
class Payslip extends CI_Controller
{
   ...
   public function index()
   {
      ...
      $data['add'] = $this->db->query("
            SELECT absen.aktivitas, karyawan.user_id, karyawan.id_karyawan, karyawan.id_jabatan, karyawan.id_departement, karyawan.nama_karyawan, jabatan.*, departement.nama_departement, 
   ...
   public function proses_multiple()
   {
      ...
      redirect('admin/payslip'); // Ganti URL redirect sesuai kebutuhan Anda
   }
