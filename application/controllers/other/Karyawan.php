...
class Karyawan extends CI_Controller
{
   ...
   public function index()
   {
      ...
      $this->load->view('other/karyawan', $data);
   ...
   public function add()
   {
      ...
      $this->load->view('layout/other/header', $data);
      $this->load->view('other/addkaryawan', $data);
      $this->load->view('layout/other/footer');
   }
   ...
   public function update($id)
   {
      ...
      $this->load->view('layout/other/header', $data);
      $this->load->view('other/updatekaryawan', $data);
      $this->load->view('layout/other/footer');
   }
   ...
   //       $this->load->view('layout/other/header', $data);
   //       $this->load->view('other/performance_detail', $data);
   //       $this->load->view('layout/other/footer');
   //    }
   // }
