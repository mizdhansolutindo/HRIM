                                   ...
                                   <td>
                                      <div class="dropdown ">
                                         ...
                                         <div class="dropdown-menu mt-4" aria-labelledby="uniqueVisitors">
                                            ...
                                            <a class="dropdown-item" href="<?= site_url('other/departement/delete/' . $row->id_departement) ?>">Delete</a>
                                         </div>
                                      </div>
                                   </td>
                                </tr>
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
           ...
           <form action="<?= site_url('other/departement/proses') ?>" method="post">
     ...
     <div class="modal fade" id="exampleModalCenter<?= $row->id_departement ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
           <div class="modal-content">
              ...
              <form action="<?= site_url('other/departement/proses_ubah') ?>" method="post">
                 <div class="modal-body">
                    <div class="row">
