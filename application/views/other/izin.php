                              ...
                              ?>
                                <tr>
                                   ...
                                   <td>
                                      ...
                                      <?php } else { ?>
                                         <a onclick="return confirm('apakah anda yakin ingin menerima pengajuan izin ini?')" href="<?php echo base_url('other/izin/accept/' . $row->id_izin) ?>" class="btn btn-sm btn-outline-success">Terima</a>
                                         <a onclick="return confirm('apakah anda yakin ingin menolak pengajuan izin ini?')" href="<?php echo base_url('other/izin/reject/' . $row->id_izin) ?>" class="btn btn-sm btn-outline-danger">Tolak</a>
                                      <?php } ?>
                                   </td>
                                </tr>
                             <?php endforeach; ?>
