                             ...
                             <?php
                              ...
                              ?>
                                <tr>
                                   ...
                                   <td>
                                      <?php if ($row->statement == 0) { ?>
                                         <a onclick="return confirm('apakah anda yakin ingin menerima pengajuan lembur ini?')" href="<?php echo base_url('other/lembur/accept/' . $row->id_lembur) ?>" class="btn btn-sm btn-outline-success">Terima</a>
                                         <a onclick="return confirm('apakah anda yakin ingin menolak pengajuan lembur ini?')" href="<?php echo base_url('other/lembur/reject/' . $row->id_lembur) ?>" class="btn btn-sm btn-outline-danger">Tolak</a>
                                      <?php } else { ?>
