...
<head>
    ...
    <link href="<?= base_url('assets') ?>/css/components/timeline/custom-timeline.css" rel="stylesheet" type="text/css" />
    ...
    <div class="main-container" id="container">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                ...
                <ul class="menu-categories">
                    <li class="menu menu-single">
                        <a href="<?= site_url('others/dashboard') ?>" class="menu-toggle">
                            <div class="base-menu">
                    ...
                    <?php if ($this->session->userdata('role') == 4 || $this->session->userdata('role') == 5 || $this->session->userdata('role') == 6) : ?>
                        <li class="menu">
                            <a href="#permintaan" data-active="false" class="menu-toggle">
                                <div class="base-menu">
                                    <div class="base-icons">
                            ...
                            <div class="tooltip"><span>Manajemen Permintaan</span></div>
                        </li>
                    <?php endif; ?>

                    <?php if ($this->session->userdata('role') == 6) : ?>
                        <li class="menu menu-single">
                            <a href="<?= site_url('others/payslip') ?>" data-active="false" class="menu-toggle">
                                <div class="base-menu">
                                    <div class="base-icons">
                        ...
                        <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                            <div class="dropdown-inner">
                                ...
                                <div class="dropdown-item">
                                    <a href="<?= site_url('others/settings') ?>">
            ...
            <div id="compact_submenuSidebar" class="submenu-sidebar">
                    ...
                    <ul class="submenu-list" data-parent-element="#more">
                        <li class="sub-submenu">
                            ...
                            <ul id="users" class="collapse" data-parent="#compact_submenuSidebar">
                                <li>
                                    <a href="<?= site_url('others/barang') ?>">Data Barang </a>
                                </li>
                                <li>
                                    <a href="<?= site_url('others/kategori') ?>">Data Kategori </a>
                                </li>
                                <li>
                                    <a href="<?= site_url('others/unit') ?>">Data Unit </a>
                                </li>
                                <li>
                                    <a href="<?= site_url('others/supplier') ?>">Data Supplier </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-submenu">
                            ...
                            <ul id="starter-kit" class="collapse" data-parent="#compact_submenuSidebar">
                                <?php if ($this->session->userdata('role') == 4 || $this->session->userdata('role') == 5) : ?>
                                    <li>
                                        <a href="<?= base_url('others/barang_masuk') ?>"> Barang Masuk </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url('others/barang_keluar') ?>"> Barang Keluar </a>
                                    </li>
                                <?php endif; ?>
                                <?php if ($this->session->userdata('role') == 6) : ?>
                                    <li>
                                        <a href="<?= base_url('others/barang_masuk') ?>"> Order Masuk </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                ...
                <div class="submenu" id="permintaan">
                    <div class="menu-title">
                        <h3>Permintaan</h3>
                    </div>
                    <ul class="submenu-list" data-parent-element="#more">
                        <li class="sub-submenu">
                            <a role="menu" class="collapsed" data-toggle="collapse" data-target="#starter-kit" aria-expanded="false">
                                <div>Daftar Permintaan</div> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                    <polyline points="9 18 15 12 9 6"></polyline>
                                </svg>
                            </a>
                            <ul id="starter-kit" class="collapse" data-parent="#compact_submenuSidebar">
                                <?php if ($this->session->userdata('role') == 4) : ?>
                                    <li>
                                        <a href="<?= base_url('others/permintaan') ?>"> Permintaan User </a>
                                    </li>
                                <?php elseif ($this->session->userdata('role') == 5) : ?>
                                    <li>
                                        <a href="<?= base_url('others/permintaan_gudang') ?>"> Permintaan Gudang </a>
                                    </li>
                                <?php elseif ($this->session->userdata('role') == 6) : ?>
                                    <li>
                                        <a href="<?= base_url('others/permintaan_purchasing') ?>"> Permintaan Purchase </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
