         ...
         <nav id="compactSidebar">
            ...
            <ul class="menu-categories">
               <li class="menu menu-single">
                  <a href="<?= site_url('other/dashboard') ?>" class="menu-toggle">
                     <div class="base-menu">
               ...
               <?php if ($this->session->userdata('role') == 2) : ?>
                  <li class="menu">
                     ...
                     <div class="tooltip"><span>Master Data</span></div>
                  </li>
                  <li class="menu menu-single">
                     <a href="<?= site_url('other/karyawan') ?>" class="menu-toggle">
                        <div class="base-menu">
                           <div class="base-icons">
                  ...
                  <li class="menu menu-single">
                     <a href="<?= site_url('other/absensi') ?>" class="menu-toggle">
                        <div class="base-menu">
                           <div class="base-icons">
                  ...
                  <li class="menu menu-single">
                     <a href="<?= site_url('other/lembur') ?>" data-active="false" class="menu-toggle">
                        <div class="base-menu">
                           <div class="base-icons">
                  ...
                  <li class="menu menu-single">
                     <a href="<?= site_url('other/izin') ?>" data-active="false" class="menu-toggle">
                        <div class="base-menu">
                           <div class="base-icons">
                  ...
                  <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                     <div class="dropdown-inner">
                        ...
                        <div class="dropdown-item">
                           <a href="<?= site_url('other/settings') ?>">
         ...
         <div id="compact_submenuSidebar" class="submenu-sidebar">
            ...
            <div class="submenu" id="app">
               ...
               <ul class="submenu-list" data-parent-element="#app">
                  <li>
                     <a href="<?= site_url('other/jabatan') ?>"> Jabatan </a>
                  </li>
                  <li>
                     <a href="<?= site_url('other/departement') ?>"> Departement </a>
                  </li>
                  <li>
                     <a href="<?= site_url('other/grade') ?>"> Grade </a>
                  </li>
               </ul>
            </div>
