      ...
      <div class="body">
         <table class="w-100">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>Rp. <?= is_numeric($row->tunjangan_aktivitas) && is_numeric($row->qty) ? number_format($row->tunjangan_aktivitas * $row->qty) : '0' ?></td>
               </tr>
               ...
               <tr>
                  <td>Bonus Kinerja</td>
                  <td>Rp. <?= number_format($row->bonus_kinerja, 2) ?></td>
               </tr>
            </tbody>
         </table>
         <hr class="hr-dash">
         ...
         <table class="w-100">
            ...
            <tbody>
               <tr>
                  <td>PPH 21</td>
                  <td>Rp. <?= number_format($row->pph21, 2) ?></td>
               </tr>
         ...
         <table class="w-100">
            <thead>
               <tr>
                  ...
                  <td><b>Rp. <?= is_numeric($row->tunjangan_aktivitas) && is_numeric($row->qty) ? number_format($row->tunjangan_aktivitas * $row->qty + $row->gaji_pokok + $row->tunjangan_jabatan + $row->tunjangan_makan + $row->upah_lembur + $row->bonus_kinerja - $row->pph21 - $row->bpjs - $row->pinjaman - $row->pot_absensi) : '0' ?></b></td>
               </tr>
               <tr>
                  <td colspan="4" class="line"></td>
               </tr>
