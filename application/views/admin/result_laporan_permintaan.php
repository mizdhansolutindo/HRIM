                                      ...
                                      <?php $no = 1;
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td><?php echo date('d F Y', strtotime($row->deadline_at)); ?></td>
                                              <td>
                                                  <?php if ($row->status_permintaan == 'accept') { ?>
                                                      <span class="badge badge-primary text-white"> Disetujui </span>
                                                  <?php } elseif ($row->status_permintaan == 'in process') { ?>
                                                      <span class="badge badge-secondary text-white"> Dalam Proses </span>
                                                  ...
                                                  <?php } elseif ($row->status_permintaan == 'finish') { ?>
                                                      <span class="badge badge-success text-white"> Permintaan Selesai </span>
                                                  <?php } ?>
                                              </td>
                                          </tr>
                                      <?php endforeach; ?>
