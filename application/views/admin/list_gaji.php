           ...
           <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="widget widget-chart-three">
                 <div class="widget-heading">
                    ...
                    <div class="dropdown ">
                       <a class="btn btn-sm btn-secondary" href="<?= site_url('admin/payslip/hitung_gaji') ?>">
                 ...
                 <div class="widget-content">
                    <div class="widget-content widget-content-area br-6">
                       ...
                       <form method="POST" action="<?= base_url('admin/payslip/proses_multiple'); ?>">
                                ...
                                <?php $no = 1;
                                 foreach ($add as $row) : ?>
                                   <tr>
                                      ...
                                      <td><input type="text" class="form-control" name="qty[]" value="<?= $row->total_aktivitas; ?>" readonly></td>
                              ...
                              foreach ($data as $row) : ?>
                                <tr>
                                   ...
                                   <td>
                                      ...
                                      <a class="btn btn-sm btn-outline-dark" target="_blank" href="<?= site_url('admin/payslip/exportToPDF/' . $row->id_pembayaran) ?>">Download</a>
                                   </td>
                                </tr>
                             <?php endforeach; ?>
                          </tbody>
     ...
     <div class="modal fade" id="exampleModalCenter<?= $row->id_pembayaran ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
           <div class="modal-content">
              ...
              <form action="<?= site_url('admin/payslip/proses_ubah') ?>" method="post">
