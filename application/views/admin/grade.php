                                   ...
                                   <td>
                                      <div class="dropdown ">
                                         ...
                                         <div class="dropdown-menu mt-4" aria-labelledby="uniqueVisitors">
                                            ...
                                            <a class="dropdown-item" href="<?= site_url('admin/grade/delete/' . $j->id_grade) ?>">Delete</a>
                                         </div>
                                      </div>
                                   </td>
                                </tr>
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
           ...
           <form action="<?= site_url('admin/grade/proses') ?>" method="post">
              <div class="modal-body">
                 <div class="row">
                    <div class="col-md-12">
                       <label class="ml-1">Nama Grade <span class="text-danger">*</span></label>
                       <input type="text" name="nama" class="form-control" placeholder="Nama Grade">
                    </div>
     ...
     <div class="modal fade" id="exampleModalCenter<?= $j->id_grade ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
              ...
              <form action="<?= site_url('admin/grade/proses_ubah') ?>" method="post">
                 <div class="modal-body">
                    <div class="row">
                       ...
                       <div class="col-md-12">
                          ...
                          <input type="text" name="nama" class="form-control" value="<?= $j->nama ?>">
                       </div>
