              ...
              <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                  <div class="widget widget-chart-three">
                      <div class="widget-heading">
                          <div class="">
                              <h5 class="">Pengajuan Permintaan Staff Gudang</h5>
                          </div>
                      </div>
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <?php if ($row->status == 'accept') { ?>
                                                      <button onclick="accPurchasingStatusChange('<?php echo base_url('others/permintaan_gudang/konfirmasi/' . $row->id) ?>')" class="btn btn-sm btn-primary"><i class="fas fa-check"></i></button>
                                                  <?php } ?>
                                              </td>
                                          </tr>
                                      <?php endforeach; ?>
