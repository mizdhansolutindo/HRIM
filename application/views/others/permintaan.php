                                              ...
                                              <?php if ($this->session->userdata('role') == 4) : ?>
                                                  <td>
                                                      <?php if ($row->status == 'waiting confirm') { ?>
                                                          <button onclick="confirmStatusChange('<?php echo base_url('others/permintaan/konfirmasi/' . $row->id) ?>')" class="btn btn-sm btn-primary"><i class="fas fa-check"></i></button>
                                                      <?php } ?>
                                                      <?php if ($row->status == 'waiting confirm') { ?>
                                                          <button onclick="rejectStatusChange('<?php echo base_url('others/permintaan/reject/' . $row->id) ?>')" class="btn btn-sm btn-danger"><i class="fas fa-close"></i></button>
                                                      <?php } ?>
                                                  </td>
                                              <?php endif; ?>
                                          </tr>
