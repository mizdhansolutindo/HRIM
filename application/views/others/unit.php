                                                  ...
                                                  <td>
                                                      <div class="dropdown ">
                                                          ...
                                                          <div class="dropdown-menu mt-4" aria-labelledby="uniqueVisitors">
                                                              ...
                                                              <a class="dropdown-item" href="<?= site_url('others/unit/delete/' . $row->id_unit) ?>">Delete</a>
                                                          </div>
                                                      </div>
                                                  </td>
                                              <?php endif; ?>
  ...
  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
          <div class="modal-content">
              ...
              <form action="<?= site_url('others/unit/proses') ?>" method="post">
      ...
      <div class="modal fade" id="exampleModalCenter<?= $row->id_unit ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
              <div class="modal-content">
                  ...
                  <form action="<?= site_url('others/unit/proses_ubah') ?>" method="post">
                      <div class="modal-body">
                          <div class="row">
